...
class Coin:
    cents = 1 # will be provided by subclasses, but not by Coin itself
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        self.years = Mint.present_year - self.year
        return self.cents + self.years - 50 if self.years - 50 > 0 else self.cents
